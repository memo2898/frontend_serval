import type { Subfamilias, SubfamiliasGridRow } from '../subfamilias.types';

export interface SubfamiliasHandlers {
  onEdit: (subfamilias: Subfamilias) => void;
  onDelete: (subfamilias: Subfamilias) => void;
}
...
export const toSubfamiliasGridRow = (subfamilias: Subfamilias, handlers: SubfamiliasHandlers): SubfamiliasGridRow => ({
  ...
  actualizado_en: subfamilias.actualizado_en,
  actualizado_por: subfamilias.actualizado_por,
  actions: [
    {
      content: `
        ${actionButtonStyles}
      ...
      `,
      event: 'click',
      funct: () => handlers.onEdit(subfamilias),
    },
    {
      content: `
      ...
      `,
      event: 'click',
      funct: () => handlers.onDelete(subfamilias),
    },
  ],
});

export const toSubfamiliasGridRows = (subfamilias: Subfamilias[], handlers: SubfamiliasHandlers): SubfamiliasGridRow[] =>
  subfamilias.map((subfamilias) => toSubfamiliasGridRow(subfamilias, handlers));
