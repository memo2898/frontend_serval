...
export const toPermisosGridRow = (permisos: Permisos, handlers: PermisosHandlers): PermisosGridRow => ({
  id: permisos.id,
  ...
  //     `,
  //     event: 'click',
  //     funct: () => handlers.onEdit(permisos),
  //   },
  //   {
  //     content: `
  ...
  //     `,
  //     event: 'click',
  //     funct: () => handlers.onDelete(permisos),
  //   },
  // ],
});
