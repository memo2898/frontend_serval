import type { Articulos, ArticulosGridRow } from '../articulos.types';
...
export const toArticulosGridRow = (articulos: Articulos, handlers: ArticulosHandlers): ArticulosGridRow => ({
  id: articulos.id,
  familia_id: articulos.familia_id,
  ...
  actions: [
    {
      ...
      `,
      event: 'click',
      funct: () => handlers.onEdit(articulos),
    },
    {
      content: `
      ...
      `,
      event: 'click',
      funct: () => handlers.onDelete(articulos),
    },
  ],
});

export const toArticulosGridRows = (articulos: Articulos[], handlers: ArticulosHandlers): ArticulosGridRow[] =>
  articulos.map((articulos) => toArticulosGridRow(articulos, handlers));
