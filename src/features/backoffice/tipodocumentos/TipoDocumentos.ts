      ...
      onSubmit: async (result) => {
        ...
        try {
          const data: TipoDocumentosCreateDTO = {
            ...
            regex_validacion: result.body['regex_validacion'] as string,
            funcion_validacion: result.body['funcion_validacion'] as string,
            formato_ejemplo: result.body['formato_ejemplo'] as string,
          };
